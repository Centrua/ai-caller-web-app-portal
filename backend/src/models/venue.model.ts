...
interface VenueCreationAttributes extends Optional<VenueAttributes, 'id' | 'email' | 'phone' | 'elevenlabs_agent_id' | 'kb_document_id' | 'nylas_grant_id' | 'associated_user_ids' | 'created_at'> {}
