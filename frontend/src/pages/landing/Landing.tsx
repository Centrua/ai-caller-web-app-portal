        ...
        <div className="min-h-screen bg-white text-slate-900 relative">
            ...
            <nav className="flex items-center justify-between px-8 py-5 max-w-6xl mx-auto border-b border-slate-100">
                ...
                <div className="flex items-center gap-4">
                    <Link
                        to="/register"
                        className="text-sm font-medium text-[#2B3528] hover:text-[#444B38] transition-colors"
                    >
                        Register venue
                    </Link>
                    <Link
            ...
            <section className="max-w-6xl mx-auto px-8 pt-24 pb-32 text-center">
                <div className="inline-flex items-center gap-2 bg-[#20241C]/5 border border-[#2B3528]/20 text-[#2B3528] text-xs font-medium px-3.5 py-1.5 rounded-full mb-8">
                ...
                <h1 className="text-6xl font-bold leading-[1.1] tracking-tight mb-6 max-w-3xl mx-auto text-slate-900">
                    Your venue's{' '}
                    <span className="bg-gradient-to-r from-[#161915] via-[#2B3528] to-[#444B38] bg-clip-text text-transparent">
                        AI receptionist
                    </span>
                    , always on call
                </h1>
                ...
                <div className="flex items-center justify-center gap-4">
                    <Link
                        to="/register"
                        className="bg-[#2B3528] hover:bg-[#444B38] text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 shadow-lg shadow-[#2B3528]/20"
                    >
                        Register venue
                    </Link>
                    <a
                ...
                <div className="mt-20 bg-slate-50 border border-slate-200 rounded-2xl p-1 shadow-xl shadow-slate-200/80 max-w-4xl mx-auto">
                    <div className="flex rounded-xl overflow-hidden">
                        {/* Sidebar preview */}
                        <div className="w-48 bg-[#161915] p-4 border-r border-white/5 shrink-0">
                            <div className="flex items-center gap-2 mb-6 px-1">
                                <div className="w-6 h-6 rounded-md bg-[#2B3528] shrink-0"></div>
                                <div className="h-2.5 w-20 bg-white/10 rounded-full"></div>
                            </div>
                            {['Dashboard', 'Conversations', 'Knowledge Base'].map((item, i) => (
                                <div
                                    key={item}
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg mb-1 ${i === 0 ? 'bg-[#2B3528]' : ''}`}
                                >
                            ...
                            <div className="grid grid-cols-4 gap-3 mb-5">
                                {[...Array(4)].map((_, i) => (
                                    <div key={i} className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm">
                                        ...
                                        <div className="h-1.5 w-8 bg-[#444B38]/30 rounded-full"></div>
                                    </div>
                                ))}
                            </div>
                ...
                <div className="max-w-6xl mx-auto px-8 py-24">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        {features.map((feature) => (
                            <div key={feature.title} className="bg-white border border-slate-200 rounded-2xl p-7 hover:border-[#2B3528]/40 hover:shadow-md transition-all duration-200 shadow-sm">
            ...
            <section className="bg-slate-50 border-t border-slate-100">
                <div className="max-w-6xl mx-auto px-8 py-24">
                    <div className="bg-gradient-to-br from-[#161915] to-[#2B3528] rounded-3xl p-16 text-center shadow-xl shadow-[#161915]/20">
                        <h2 className="text-4xl font-bold mb-4 text-white">Ready to transform your venue?</h2>
                        <p className="text-[#444B38]/80 mb-8 max-w-md mx-auto text-slate-200">Join forward-thinking venues already using Centrua to win more bookings with less effort.</p>
                        <Link
                            to="/register"
                            className="inline-flex bg-white hover:bg-slate-50 text-[#161915] font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 shadow-lg"
                        >
                            Register your venue
                        </Link>
                    </div>
